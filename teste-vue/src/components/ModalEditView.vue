  ...
  <transition name="fade">
    <div v-if="isOpen" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div class="bg-white p-6 rounded-lg shadow-lg w-96 relative">
        ...
        <BaseButton label="Cancelar" bgColor="bg-gray-400" textColor="text-white" @click="emit('close')" class="rounded" />
        <BaseButton label="Salvar" bgColor="bg-blue-500" textColor="text-white" @click="saveEdit" class="rounded hover:bg-blue-600" />
